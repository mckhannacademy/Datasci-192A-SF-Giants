...
Analysis: Folders contain per-team data analysis graphics, including boxplots, heatmaps (used on dashboard), linear plots, regression outputs, distributions. Legacy versions of these plots also included. Visuals made through notebooks in the analysis folder - each notebook's role is explained in the top comment.
